...
const fetchCertificates = async (jsonTargetPath = './public/certificate-list.json') => {
  const headers = {
  ...
  console.info(`Storing certs on ${jsonTargetPath}`)
  await fs.writeFile(jsonTargetPath, certificateListJson)
